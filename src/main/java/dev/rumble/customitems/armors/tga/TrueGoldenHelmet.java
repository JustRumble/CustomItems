...
public class TrueGoldenHelmet extends CustomItem {

    public TrueGoldenHelmet(Customitems plugin) {
        super(11001, plugin);
    }
    ...
    public void registerRecipe(Plugin plugin){
        ...
        NamespacedKey key = new NamespacedKey(plugin, "true_golden_helmet");
