...
public class TrueGoldenBoots extends CustomItem {

    public TrueGoldenBoots(Customitems plugin) {
        super(11004, plugin);
    }
    ...
    public void registerRecipe(Plugin plugin){
        ...
        NamespacedKey key = new NamespacedKey(plugin, "true_golden_boots");
