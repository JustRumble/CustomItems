...
public class TrueGoldenLeggings extends CustomItem {

    public TrueGoldenLeggings(Customitems plugin) {
        super(11003, plugin);
    }
    ...
    public ItemStack getItem(){
        ...
        if (meta != null){
            ...
            lore.add("El verdadedo poder del pantalon de oro");
            lore.add("Se dice que su portador obtiene efectos OP");
            lore.add("Al tener la armadura completa");
            meta.setDisplayName("§6§lTrue golden leggings");
            meta.setLore(lore);
    ...
    public  void registerRecipe(Plugin plugin){
        ...
        NamespacedKey key = new NamespacedKey(plugin, "true_golden_leggings");
